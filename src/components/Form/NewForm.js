...
const NewForm = () => {
  const steps = ["New form Basic Details", "Address Details", "Other Details"];
            ...
            <div className="docs">
              ...
              <div className="doc">
                ...
                <div className="inputFile">
                  ...
                  <p>
                    * Please upload clear ORIGINAL(not xerox/photocopy) PAN Pic
                    in image/pdf formatshowing all the details fully
                  </p>
                </div>
              </div>
              <div className="doc">
